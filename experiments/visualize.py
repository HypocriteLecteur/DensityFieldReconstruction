...
def run_interactive_gmm_plotter(config_path: str, log_file_path: str):
    """
    ...
    """
    try:
        plotter = GMMInteractivePlotter(config_path, log_file_path)
        plotter.run()
...
if __name__ == "__main__":
    ...
    if not os.path.exists(config_path):
        ...
        run_interactive_gmm_plotter(config_path, log_file_path)