...
| Plot archive | `experiments.dfr_plot`, `experiments.DFR_PLOT_CATALOG.md` | Compatibility wrappers plus archive-only historical functions. Do not add new callers to archive-only functions. |
