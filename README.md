...
| `dfr_plot.py` | Legacy 3,900-line publication/reconstruction plot collection; Phase 6 inventory is in `experiments/DFR_PLOT_CATALOG.md`, and camera/trajectory/2D projection/mode-count rendering now delegates to `dfr.plotting`. |
